...
function fetch(objetoRequisicao, callback) {
    var xhr;
    ...
    xhr.open(objetoRequisicao.type, objetoRequisicao.url, true);
    
    if (objetoRequisicao.type === "POST") {
        xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    }
    xhr.send(objetoRequisicao.data);
}
